...
/** new unified slots **/
    ...
    void slot_patternToggleStep(int id);
    void slot_patternCopyCurrentTo(int subchannelId);

    void slot_functionSelect(enum id);


    void slot_subchannelSelect(int id);

    void slot_sampleSelect(QString pathAndName);

    void slot_uiChangePage(enum id);
    void slot_uiChangeOverlay(enum id);
    void slot_uiSetFullScreen(void);
    void slot_uiSetNormalScreen(void);
